...
tellraw @a [{"text": "-天气变化-\n","color": "aqua"},{"text": "        [开启]","clickEvent":{"action":"run_command","value":"/function party:ruless/weathtrue_keepflse"},"color": "gray"},{"text": "        [关闭]","clickEvent":{"action":"run_command","value":"/function party:ruless/weathfalse_too"},"color": "gray"}]
